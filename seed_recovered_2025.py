...
SCORES = [
    ...
    ("main", 6, "Drop Shotz", "The Boast Beasts", 3, 1, "Jack Hager, Robert Gentil", "Skylyr Phillips, Nick Farrell", "0 / 5"),
    ("main", 6, "The Double Troubles", "Tin and Tonic", 3, 2, "Bob Reynolds, Peter Thacker", "Trey Packard, Billy Mitchell", "0 / 1"),
    ("main", 7, "Tin and Tonic", "The Boast Beasts", 3, 2, "Billy Miller, Alan Stone", "Skylyr Phillips, Nick Farrell", "0 / 8"),
    ("open", 1, "El Mustachios", "Fatty and Friends", 3, 1, "Mark Davis, John Street", "Scott Harrison, Ned Sinnott", "0-5"),
    ("open", 1, "Mack Attack", "All the right Angles", 3, 1, "Andy Mack, David Shepardson", "Robert Angle, Charles Kempe", "2-0"),
    ...
    ("open", 5, "Mack Attack", "Team Nitro", 3, 1, "Andy Mack, David Shepardson", "Manoli Loupassi, Dean King", "0-6"),
    ...
    ("open", 6, "Fatty and Friends", "Mack Attack", 3, 2, "Scott Harrison, Ned Sinnott", "David Shepardson, Michael Halloran", "0-3"),
